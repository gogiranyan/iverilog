...
def process_test(item: list) -> str:
    ...
    # This is th name of the test, and the name of the main sorce file
    it_key = item[0]
    ...
    if it_type == "NI":
        ...
        res = run_ivl.run_normal(it_key, it_directory, it_args)

    elif it_type == "CE":
        res = run_ivl.run_CE(it_key, it_directory, it_args)
